...
public class DigitalWatchFaceService extends CanvasWatchFaceService {
    ...
    /**
     * Update rate in milliseconds for normal (not ambient and not mute) mode. We update twice a second to blink the
     * colons.
     */
    ...
    private class Engine extends CanvasWatchFaceService.Engine
        ...
        private static final long LOAD_MEETINGS_DELAY_MS = 500;

        /** How often {@link #mUpdateTimeHandler} ticks in milliseconds. */
        long mInteractiveUpdateRateMs = NORMAL_UPDATE_RATE_MS;

        private LoadMeetingsTask mLoadMeetingsTask;
        ...
        GoogleApiClient mGoogleApiClient = new GoogleApiClient.Builder(
                DigitalWatchFaceService.this).addConnectionCallbacks(this)
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(DigitalWatchFaceService.this).setCardPeekMode(
        ...
        public void onVisibilityChanged(boolean visible) {
            ...
            if (visible) {
                ...
                mUpdateTimeHandler.sendEmptyMessage(MSG_LOAD_MEETINGS);
                ...
                mUpdateTimeHandler.removeMessages(MSG_LOAD_MEETINGS);
                cancelLoadMeetingTask();
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            float amPmSize = resources.getDimension(
                    isRound ? R.dimen.digital_am_pm_size_round : R.dimen.digital_am_pm_size);
        ...
        public void onPropertiesChanged(Bundle properties) {
            ...
            if (Log.isLoggable(TAG, Log.DEBUG)) {
                Log.d(TAG, "onPropertiesChanged: burn-in protection = " + burnInProtection + ", low-bit ambient = "
                        + mLowBitAmbient);
            }
        }
            ...
            DigitalWatchFaceUtil.fetchConfigDataMap(mGoogleApiClient,
                                                    new DigitalWatchFaceUtil.FetchConfigDataMapCallback() {
                                                        ...
                                                        public void onConfigDataMapFetched(DataMap startupConfig) {
                                                            // If the DataItem hasn't been created yet or some keys
                                                            // are missing,
                                                            // use the default values.
                                                            setDefaultValuesForMissingConfigKeys(startupConfig);
                                                            DigitalWatchFaceUtil.putConfigDataItem(mGoogleApiClient,
                                                                                                   startupConfig);
        ...
        /**
         * Updates the color of a UI item according to the given {@code configKey}. Does nothing if {@code configKey}
         * isn't recognized.
         *
        ...
        private void onMeetingsLoaded(Integer result) {
            ...
            if (isVisible()) {
                mUpdateTimeHandler.sendEmptyMessageDelayed(MSG_LOAD_MEETINGS, LOAD_MEETINGS_DELAY_MS);
            }
        }
